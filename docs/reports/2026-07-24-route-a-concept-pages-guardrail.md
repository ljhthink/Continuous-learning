...
**修复建议**：在 [ingest-workflow.md](../../wiki/kb-system/ingest-workflow.md) 的"与其他工作流的关系"表格或"相关概念"段，以及 [lint-workflow.md](../../wiki/kb-system/lint-workflow.md) 的"相关概念"段，补充 `[[wiki/kb-system/query-workflow]]` 链接。ingest-workflow.md L75-81 的"与其他工作流的关系"表格已用纯文本提及 Query 工作流，但未使用 wiki 链接格式，建议改为链接。
